...
public:
  ...
  /*  int i = 0;
    ...
    {
        refreshed_counters.push_back(RefCounter(rank->id, (long)((ctrl->channel->spec->speed_entry.nREFI/ctrl->channel->spec->speed_entry.tCK)/max_rank_count) * (0+1) - ctrl->channel->spec->speed_entry.nREFI));
        i++;
    }
*/
  }
