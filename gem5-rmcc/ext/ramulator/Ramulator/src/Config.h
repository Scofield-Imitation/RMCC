...
//xinw added for generating trace file-begin

    std::string trace_name;
    uint64_t generate_trace;
//xinw added for generating trace file-end
public:
    Config() {}
...
//xinw added for generating trace file-begin
    void set_trace_name(std::string _trace_name) { trace_name=_trace_name; }
    void set_generate_trace(uint64_t _generate_trace) {generate_trace=_generate_trace; }
    std::string get_trace_name() const { return trace_name; }
    uint64_t get_generate_trace() const { return generate_trace; }
//xinw added for generating trace file-end
