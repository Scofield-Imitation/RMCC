...
map<string, enum DDR4::Speed> DDR4::speed_map = {
    {"DDR4_100K", DDR4::Speed::DDR4_100K},
    {"DDR4_200K", DDR4::Speed::DDR4_200K},
    {"DDR4_400K", DDR4::Speed::DDR4_400K},
    {"DDR4_800K", DDR4::Speed::DDR4_800K},
    {"DDR4_1600_base", DDR4::Speed::DDR4_1600_base},
    ...
    {"DDR4_3200_base_reduced", DDR4::Speed::DDR4_3200_base_reduced},
    ...
    {"DDR4_2000_base", DDR4::Speed::DDR4_2000_base},
};
...
void DDR4::init_speed()
{
    ...
    if(mySpeed != DDR4::Speed::DDR4_3200_base
            && mySpeed != DDR4::Speed::DDR4_3200_base_reduced
            ...
            && mySpeed != DDR4::Speed::DDR4_2000_base
       //xinw
	/*    && mySpeed != DDR4::Speed::DDR4_100K
	    && mySpeed != DDR4::Speed::DDR4_200K
	    && mySpeed != DDR4::Speed::DDR4_400K
	    && mySpeed != DDR4::Speed::DDR4_800K
	    && mySpeed != DDR4::Speed::DDR4_1600K 
	    && mySpeed != DDR4::Speed::DDR4_1600_base */
       // gagan
